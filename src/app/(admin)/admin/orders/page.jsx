...
export default async function page() {
  ...
  return (
    <Layout>
      ...
      <div className="flex flex-col text-[#706e6b]">
        <div className="overflow-x-auto sm:-mx-6 lg:-mx-8">
          <div className="inline-block min-w-full py-2 sm:px-6 lg:px-8 space-y-6">
            {Active.length > 0 ? (
              <>
                <h1 className="font-bold text-xl mt-6">Pedidos Activos</h1>
                <div className={`overflow-y-scroll 
                              ${Inactive ? 'h-[40vh] no-scrollbar' : 'h-[40vh]'}  
            ...
            <div className={`overflow-y-scroll h-[40vh] ${Inactive && Inactive.length <= 5 ? 'no-scrollbar' : ''}`}>
              {Inactive.length > 0 ? (
                <table className="min-w-full text-left text-md font-light text-surface">
                  <thead className="border-b border-neutral-200 font-medium">
                    <tr>
                ...
                <div className="h-[40vh] flex flex-col space-y-20">
                  <div className="flex flex-col justify-center items-center ">
                    ...
                    <svg width="160px" height="160px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M9.5 13.4L10.9286 15L14.5 11" stroke="#706e6b" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path> <path d="M20.5 7V13C20.5 16.7712 20.5 18.6569 19.3284 19.8284C18.1569 21 16.2712 21 12.5 21H11.5M3.5 7V13C3.5 16.7712 3.5 18.6569 4.67157 19.8284C5.37634 20.5332 6.3395 20.814 7.81608 20.9259" stroke="#706e6b" strokeWidth="1.5" strokeLinecap="round"></path> <path d="M12 3H4C3.05719 3 2.58579 3 2.29289 3.29289C2 3.58579 2 4.05719 2 5C2 5.94281 2 6.41421 2.29289 6.70711C2.58579 7 3.05719 7 4 7H20C20.9428 7 21.4142 7 21.7071 6.70711C22 6.41421 22 5.94281 22 5C22 4.05719 22 3.58579 21.7071 3.29289C21.4142 3 20.9428 3 20 3H16" stroke="#706e6b" strokeWidth="1.5" strokeLinecap="round"></path> </g></svg>
                  </div>
                </div>
              )}
            </div>
