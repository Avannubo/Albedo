...
export default function page() {
    return (
        <Layout>
            <hr className="h-1 mx-auto bg-gray-100 border-0 rounded dark:bg-gray-700 mt-12" />
            <div className="flex justify-center my-4">
                <h1 className="text-3xl font-bold self-center text-center">Preguntas Frecuentes (FAQ)</h1>
            </div>
            ...
            <div className='flex flex-col'>
                <div className="flex justify-center my-4">
                    ...
                    <h1 className="text-xl font-bold text-center">¿Cómo puedo comprar sus productos?</h1>
                </div>
                <div className='text-xl space-y-4 mb-4'>
                    ...
                    <hr className="h-1 mx-auto bg-gray-100 border-0 rounded dark:bg-gray-700" />
                    <div className="flex justify-center my-4">
                        <h1 className="text-xl font-bold self-center text-center">¿Cómo puedo comprar sus productos?</h1>
                    </div>
                    <p className='text-justify'>
