        ...
        <Layout>
            ...
            <div className=' space-y-4 mb-4'> 
                <div className="flex justify-start my-4 text-2xl ">
                    <h1 className="text-2xl font-bold">¿Qué son las cookies?</h1>
                </div>
                ...
                <div className="flex justify-start my-4 text-2xl ">
                    <h1 className="text-2xl font-bold">¿Por qué no usamos cookies?</h1>
                </div>
                <p className='text-justify'>
                ...
                <div className="flex justify-start my-4 text-2xl ">
                    <h1 className="text-2xl font-bold">Cambios en la Política de Cookies</h1>
                </div>
                <p className='text-justify'>
