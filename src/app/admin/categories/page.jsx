...
const Category = ({ category }) => (
    <div key={category.id} className="space-y-2 w-full">
        ...
        <div className="bg-slate-300 rounded-lg p-2 flex flex-row justify-between">
            <p className="h-auto ">{category.id}</p>
        ...
        <div className="relative ">
            <svg className="absolute -top-2 left-4 " fill="#808080" width="40px" height="40px" viewBox="0 0 24.00 24.00" xmlns="http://www.w3.org/2000/svg" transform="rotate(-45)matrix(-1, 0, 0, 1, 0, 0)" stroke="#808080" stroke-width="0.00024000000000000003"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#CCCCCC" stroke-width="0.028"></g><g id="SVGRepo_iconCarrier"><path d="m4.8 21.57 2.422 2.43 11.978-12-11.978-12-2.422 2.43 9.547 9.57z"></path></g></svg>
        </div>
