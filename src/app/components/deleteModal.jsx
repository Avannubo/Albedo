        ...
        <div className="w-full max-w-md bg-white shadow-lg rounded-md p-6 relative">
            ...
            <div className="flex flex-col space-y-2">
                <Link href="#" type="button"
                    className="px-6 py-2.5 rounded-md text-white text-sm font-semibold border-none outline-none bg-red-500 hover:bg-red-600 active:bg-red-500">Delete</Link>
                <Link href="#" type="button"
                    className="px-6 py-2.5 rounded-md text-black text-sm font-semibold border-none outline-none bg-gray-200 hover:bg-gray-300 active:bg-gray-200">Cancel</Link>
            </div>
        </div>
    </div>
}