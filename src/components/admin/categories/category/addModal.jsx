        ...
        <div className="fixed inset-0 p-4 flex flex-wrap justify-center items-center w-full h-full z-[1000] before:fixed before:inset-0 before:w-full before:h-full before:bg-[rgba(0,0,0,0.5)] overflow-auto font-[sans-serif]">
            <div className="w-full max-w-2xl bg-white shadow-lg rounded-md p-6 relative">
                ...
                <div className="mb-8 text-center">
                    <div className="w-full  mb-2 md:mb-0">
                        <input onChange={handleInputChangeDescription} className="appearance-none block w-full bg-white text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" placeholder="Descripción corta" />
                    </div>
                </div>
