...
export default function AddModal({ isOpen, onClose }) {
    ...
    const handleAddCategory = () => {
        addCategory(newCategoryCode, newCategoryUrlCode, newCategoryName, newCategoryDescription, newCategoryBody);
        setNewCategoryName('');
    ...
    return isOpen ? (
        ...
        //         <div className="flex flex-row space-x-4 mt-8 text-center">
        //         <div className="w-full  mb-2 md:mb-0">
        //                 <input onChange={handleInputChangeName} className="appearance-none block w-full bg-white text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" placeholder="Codigo URL" />
        //             </div>
        //             <div className="w-full  mb-2 md:mb-0">
        //                 <input onChange={handleInputChangeName} className="appearance-none block w-full bg-white text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" placeholder="Codigo URL" />
        //             </div>
        ...
        //             <div className="w-full  mb-2 md:mb-0">
        //                 <input onChange={handleInputChangeName} className="appearance-none block w-full bg-white text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" placeholder="Nombre" />
        //             </div>
        //         </div>
        //         <div className="mb-8 text-center">
        //             <div className="w-full  mb-2 md:mb-0">
        //                 <textarea onChange={handleInputChangeDescription} className="appearance-none block w-full bg-white text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" placeholder="Descripción corta" />
        //             </div>
        //         </div>
