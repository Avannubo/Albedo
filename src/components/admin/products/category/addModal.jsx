...
export default function AddModal({ isOpen, onClose, list }) {
    ...
    const handleAddCategory = async () => {
        ...
        const urlIdExists = list.list.some(category => category.url_Id === newCategoryUrlCode); // Use 'url_Id' for comparison
