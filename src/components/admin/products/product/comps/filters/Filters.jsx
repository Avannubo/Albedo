...
export default function Filters({ list }) {
    ...
    const fetchData = async (filter) => {
        setLoading(true);
        await new Promise(resolve => setTimeout(resolve, 3200)); // Add 2000ms delay
        await getFiltersListProducts(filter);
        setLoading(false);
    };
    ...
    return (
        <>
            {loading && (
                <div className="absolute inset-0 flex justify-center items-center bg-gray-200 bg-opacity-75 z-[1000]">
