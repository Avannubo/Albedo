    ...
    <footer className="bottom-0 left-0 text-stone-700 z-40 w-full">
      ...
      <div className="flex flex-col items-center justify-start text-black space-y-6">
        <div className="flex flex-col lg:flex-row justify-end items-center space-y-6 lg:space-y-0 lg:space-x-4 py-6 w-full max-w-[1500px] px-6">
          ...
          {/* Copyright */}
          <div className="text-center lg:text-start w-full lg:w-[40%]"><div className="">
            <p className="text-[16px] lg:text-[20px]">
              Copyright © 2004 - {currentYear}  Albedo Design S.L. Todos los derechos reservados. <br></br> Si desea comprar, lea nuestros politicas:
            </p>
          </div>
            <div className="flex  flex-wrap justify-center lg:justify-start space-x-2 mt-5">
              <div className="flex flex-row md:justify-start flex-wrap justify-center md:flex md: space-x-4">
                <Link className="whitespace-nowrap text-[#304590] hover:text-[#475CAA] text-lg font-semibold" href='/privacidad'>Privacidad</Link>
                <Link className="whitespace-nowrap text-[#304590] hover:text-[#475CAA] text-lg font-semibold" href='/cookies'>Cookies</Link> 
                <Link className="whitespace-nowrap text-[#304590] hover:text-[#475CAA] text-lg font-semibold" href="/condiciones" >Términos y Condiciones</Link>
                <Link className="whitespace-nowrap text-[#304590] hover:text-[#475CAA] text-lg font-semibold" href='/aviso-legal'>Aviso Legal</Link></div>
            </div>
          </div>
          {/* Contact Section */}
